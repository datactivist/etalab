---
title: "Extraction de données avec l'API Matomo de data.gouv.fr"
output: html_notebook
---

Reprise d'un travail de Joël : https://github.com/datactivist/stats_data_gouv/blob/master/tests.Rmd
...
urls <- map_df(seq(0, 1190, 10), ~ getPageUrls(date = paste0(ymd(20170224) + days(.), ",", ymd(20170224) + days(. + 9))))

write_excel_csv(urls, "./data/data.gouv.fr/20170242_20200242_parjour_parurl.csv")
urls_mois <- urls %>% 
