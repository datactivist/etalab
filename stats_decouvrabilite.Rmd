...
# en %
percent_top10 <-(10801*100) / nrow(catalogue)
percent_top50 <-(24231*100) / nrow(catalogue)
```
...
library(stringr)
 ...
 catalogueorga_date %>% 
  ...
  geom_histogram(aes(nbtags)) + 
   labs(title = "Nombre de tags renseignés par jeux de données", caption = "Source : catalogue data.gouv.fr, 24/09/20", x="Nombre de charactères du champ description", y="Nombre de jeux de données concernés") + 
  theme_few() +
